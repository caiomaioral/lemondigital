...
function Cabecalho($titulo)
{
	...
	$this->Image(base_url() . 'assets/images/logo.png', 8, 5, 40, 18);
...
function LinhaTabela($Situacao)
{
	$Legenda = ($Situacao == 1)? 'Vencimento' : 'Pagamento';
	
	$this->Cell(100, 5, 'Aluno', 1, 0, 'C');
	$this->Cell(20, 5, 'Referencia', 1, 0, 'C');
	$this->Cell(20, 5, $Legenda, 1, 0, 'C');
	$this->Cell(20, 5, 'Nosso Numero', 1, 0, 'C');
	$this->Cell(25, 5, 'Valor', 1, 0, 'C');
	$this->ln(5);
}
