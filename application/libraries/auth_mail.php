...
class Auth_mail {
	...
	var $servidor 				=  "smtp.boladenevechurch.com.br";					// Host address. Example: mail.test.com
	var $porta					=  587; 											// Mail or SMTP port. Default: 25
	var $remetente              =  "Instituto Global";								// From name
	var $email                  =  "secretaria@institutoglobal.com.br";				// Email address of institute
	var $usuario				=  "institutoglobal@boladenevechurch.com.br";		// Mail or SMTP Username. Example: admin@test.com
